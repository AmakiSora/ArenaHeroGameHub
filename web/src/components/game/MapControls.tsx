...
export function MapControls({ onCenter, onZoom, beaconIndicatorVisible = true, onToggleBeaconIndicator, coreIndicatorVisible = true, onToggleCoreIndicator, memoryVisible = false, onToggleMemory, routesVisible = false, onToggleRoutes, memoryFilters, onToggleMemoryFilter }: { onCenter: () => void; onZoom: (direction: number) => void; beaconIndicatorVisible?: boolean; onToggleBeaconIndicator?: () => void; coreIndicatorVisible?: boolean; onToggleCoreIndicator?: () => void; memoryVisible?: boolean; onToggleMemory?: () => void; routesVisible?: boolean; onToggleRoutes?: () => void; memoryFilters?: ReadonlySet<EnemySightingType>; onToggleMemoryFilter?: (type: EnemySightingType) => void }) {
