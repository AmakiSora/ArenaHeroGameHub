...
const ERROR_KEYS = {
  ...
  COMMAND_RATE_LIMITED: 'errors.commandRateLimited',
  TICK_MISMATCH: 'errors.tickMismatch',
  INVALID_COMMAND: 'errors.invalidCommand',
  IDEMPOTENCY_CONFLICT: 'errors.commandConflict',
  IDEMPOTENCY_KEY_INVALID: 'errors.commandConflict',
  PLAYER_NOT_READY: 'errors.playerNotReady',
  TICK_NOT_READY: 'errors.playerNotReady',
  REQUEST_BODY_TOO_LARGE: 'errors.generic',
  UNSUPPORTED_MEDIA_TYPE: 'errors.generic',
  INVALID_JSON: 'errors.generic',
  SESSION_IMPORT_INVALID: 'errors.sessionImportInvalid',
  SESSION_IMPORT_EXPIRED: 'errors.sessionImportExpired',
