...
export const STRATEGY_GROUPS: StrategyGroupSpec[] = [
  {
    ...
    fields: [
      ...
      { kind: 'number', field: 'core_target_x', labelKey: 'coreTargetX', min: -10000, max: 10000, pickYField: 'core_target_y' },
      { kind: 'number', field: 'core_target_y', labelKey: 'coreTargetY', min: -10000, max: 10000 },
